...
public interface OrderSearchRepository extends PagingAndSortingRepository<Reservation, Integer> {
    ...
    Page<Reservation> findReservationByOrderNameContainsAndCar_NameContainsIgnoreCase(final String orderName, final String contractor, final Pageable pageable);
}
